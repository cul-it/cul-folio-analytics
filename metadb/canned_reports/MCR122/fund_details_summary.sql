...
-- 8-26-25: took out credits from "expenditures" (line 38/39) so it is the same as the amount displayed in the Finances app
...
SELECT 
        ...
        coalesce (budget__t.expenditures,0) as expenditures,     
