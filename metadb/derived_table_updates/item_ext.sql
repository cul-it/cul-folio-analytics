 ...
 * -- 5-27-26: included effective_shelving_order

*      -- question remains about whether to cast dates as "timestamptz"; they appear to be in UTC format.

 *      -- I added two additional date fields: updated_date_timezone, and status_date_timezone (created_date doesn't appear to need the conversion)
