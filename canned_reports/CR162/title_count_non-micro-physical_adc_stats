 ...
 * reporting. ARL asks for one title count (all formats). ACRL asks for title counts 
...
-- ~4 min; 8,705,395 records on 3/3/22
 ...
 * wanted, including microforms and remote e-resources.
 * Holdings records must be unsuppressed.*/
-- ~3 min; 6,049,672 records on 3/3/22
...
-- 1 minutes; 5,646,779 rows on 3/3/22 
...
/*Query 4: Groups and counts titles in titlprint_ct_3 by format, adding format translation.*/
-- 1 minute; 55 rows, 5,646,779 titles
SELECT DISTINCT
