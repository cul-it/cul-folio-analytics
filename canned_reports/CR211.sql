...
--This query counts the total number of items in all locations (perm and temp locations), even if there are zero items,
-- and includes suppressed and unsuppressed records. It was written for the Locations project, as requested by Tom Trutt.
