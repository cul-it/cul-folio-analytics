...
-- 4-30-24: this is a re-writing of the derived table in MetaDB finance_transaction_purchase_order
-- corrected the pol acquisition method extraction and the po order type extraction (encumbrance order type extraction is correct)
-- Added the acquisition method name to the query
